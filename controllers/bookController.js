...
exports.book_delete_post = function (req, res) {
    ...
    async.parallel({
        ...
        if (results.book_copies.length > 0) {
            // multiple copies of this book exist. Delete them first.
            // Render same as GET
            res.render('book_delete', {
                title: 'Delete book',
                book: results.book,
            ...
            // There are no copies of this book. Delete this object and redirect to the list of book
            Book.findByIdAndRemove(req.body.bookid, function(err) {
                if (err) { return next(err); }

                // Success- object deleted. Go to the books list
                res.redirect('/catalog/books');
            });
        }
    });
